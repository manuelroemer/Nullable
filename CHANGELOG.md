...
This release adds the `// <auto-generated>` header to the `NullableAttributes.cs` so that code
analyzers like StyleCop ignore the file during the static code analysis.
